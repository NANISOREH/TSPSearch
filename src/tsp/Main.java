...
public class Main {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        start = Instant.now();
        solution = TspSolver.solve(cities, Algorithm.GENETIC_SEARCH);
        finish = Instant.now();
        ...
        start = Instant.now();
        solution = TspSolver.solve(cities, Algorithm.HILL_CLIMBING);
        finish = Instant.now();
        ...
        start = Instant.now();
        solution = TspSolver.solve(cities, Algorithm.HILL_CLIMBING_RANDOM_RESTARTS);
        finish = Instant.now();
        ...
        start = Instant.now();
        solution = TspSolver.solve(cities, Algorithm.SIMULATED_ANNEALING);
        finish = Instant.now();
...
/*        start = Instant.now();
        solution = TspSolver.solve(cities, Algorithm.BRUTE_FORCE);
        finish = Instant.now();
